...
export class AppMenuComponent implements OnInit {
    ...
    ngOnInit() {
        this.model = [
            ...
            {
                label: 'Infraestructura', icon: 'pi pi-fw pi-home', routerLink: ['/edutic/infraestructura'],
                items:[ 
                    {label: 'Sedes',icon: 'pi pi-fw pi-home',routerLink:['/edutic/infraestructura/sedes']},
                    {label: 'Edificios',icon: 'pi pi-fw pi-home',routerLink:['/edutic/infraestructura/edificios']},
                    {label: 'Aulas',icon: 'pi pi-fw pi-home',routerLink:['/edutic/infraestructura/aulas']}
                ]
            },
            {
